...
## [0.11.0] - 2026-09-06
- Added HTTP compression (not sure how this was missed for so long!)
- Bundled all third-party JS libraries that had been fetched from CDNs
- Added version info and link to the GitHub repo to the admin page
- Some responsive fixes, and other design tweaks

## [0.10.1] - 2026-09-03
- Fixes broken app icons
